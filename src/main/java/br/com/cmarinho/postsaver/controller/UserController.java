...
import br.com.cmarinho.postsaver.controller.dto.UserDto;
...
@Tag(name = "Users Controller", description = "RESTful API for managing users and their saved posts.")
public record UserController(UserService userService) {
    ...
    @PostMapping
    @Operation(summary = "Create a new user", description = "Create a new user based and return the created user's data")
    @ApiResponses(value = {
