...
class _$TagImpl implements _Tag {
  const _$TagImpl({required this.id, required this.name, this.color});
...
mixin _$TagRequest {
  ...
  /// Serializes this TagRequest to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of TagRequest
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
abstract class _$$TagRequestImplCopyWith<$Res>
  ...
  factory _$$TagRequestImplCopyWith(
    _$TagRequestImpl value,
    $Res Function(_$TagRequestImpl) then,
...
class __$$TagRequestImplCopyWithImpl<$Res>
  ...
  __$$TagRequestImplCopyWithImpl(
    _$TagRequestImpl _value,
    $Res Function(_$TagRequestImpl) _then,
  ) : super(_value, _then);
...
class _$TagRequestImpl implements _TagRequest {
  const _$TagRequestImpl({required this.name, this.color});
  ...
  @override
  String toString() {
    return 'TagRequest(name: $name, color: $color)';
  }
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$TagRequestImplToJson(this);
  }
}

abstract class _TagRequest implements TagRequest {
  const factory _TagRequest({required final String name, final String? color}) =
      _$TagRequestImpl;
